...
(function(){
  var crypt = __webpack_require__(904),
      utf8 = __webpack_require__(837).utf8,
      isBuffer = __webpack_require__(766),
      bin = __webpack_require__(837).bin,
...
async function getAcl() {
  ...
  if (!res.ok) {
    ...
    throw new Error(`ACL error ${err.message.toString()}`);
  }
